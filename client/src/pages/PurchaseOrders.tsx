...
import { formatDateShort, getStatusBadge } from "../lib/formatters";
...
export default function PurchaseOrders() {
  ...
  if (isLoading) return <LoadingOverlay message="Loading purchase orders..." />;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Track orders to manufacturers from creation through delivery.
          </p>
        </div>
        <Link
          to="/stock/reorder"
